  ...
  return (
    <div className="max-w-[1000px] mx-auto px-4 sm:px-6 lg:px-16 py-8 lg:py-12 space-y-8">
      ...
      <p className="text-gray-400 mb-8 text-center max-w-2xl">
        A curated list of awesome, battle tested Tailwind CSS button components
      </p>
          ...
          <table className="w-full text-left border-collapse min-w-[600px]">
            <thead>
              <tr className="border-b border-gray-700">
                <th className="px-4 py-3 text-sm font-semibold text-gray-300 uppercase tracking-wider">
                  Prop
                </th>
                <th className="px-4 py-3 text-sm font-semibold text-gray-300 uppercase tracking-wider">
                  Type
                  ...
                  type: (
                    <div className="flex flex-wrap gap-1">
                      {[
                        ...
                        <span
                          key={v}
                          className="px-2 py-1 text-xs font-mono bg-blue-700 text-white rounded-md shadow-sm"
                        >
                          {v}
                        </span>
                      ))}
